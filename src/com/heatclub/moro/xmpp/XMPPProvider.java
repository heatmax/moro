...
public class XMPPProvider extends XMPPTCPConnection
{
	...
	XMPPProvider(ConnectionConfiguration config){
		super(config);
		init();
	}
	
	XMPPProvider(final String domain, final int port, final String server){		
